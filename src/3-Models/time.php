 ...
 *
 * model que gestiona totes les peticions de la pagina adinistrado config.
 **/
namespace bd;
...
class time
{
    ...
    public function updateTime($weekdays)
    {
        ...
        foreach ($weekdays as $day) {
            ...
            $query = 'UPDATE horari_tb SET horari_hora_obert = :horari_hora_obert, horari_hora_tencat = :horari_hora_tencat, horari_tencat = :horari_tencat WHERE horari_id = :horari_id';
